...
ざっくりした貯金額、借金額、投資残高を把握したい場合は、
`input/assets/snapshot.csv` に基準日の残高を入力できます。

```csv
基準日,貯金額,借金額,投資残高
2026/01/01,1000000,500000,800000
```

レポートでは、基準日以降の収入・生活支出・投資・奨学金返済を反映して
月ごとの概算残高を表示します。
